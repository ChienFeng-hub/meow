...
# class CondLinear(Flow):

#     def __init__(self, state_dim, act_dim):
#         super().__init__()

#         # Define modules
#         self.hypernetwork = HyperNetwork(f_size=1, z_dim=state_dim, out_size=act_dim, in_size=act_dim)

#     def forward(self, z, context=None):
#         weight = self.hypernetwork(context)
#         z = torch.nn.functional.linear(input=z, weight=weight)
#         log_det = 
#         return z, log_det.view(-1)
